...
def _safe_result(bundle: dict) -> dict:
    ...
    return {
        ...
        "grounded": bundle.get("grounded", bool(bundle["found"]["documents"])),
        "citationStyle": bundle.get("citation_style", "not_reported"),
        "citationStatus": bundle.get("citation_status", "not_checked"),
